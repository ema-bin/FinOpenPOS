...
export async function POST(request: Request) {
  try {
    ...
    const { name, description, category_id, is_puntuable, is_category_specific, is_suma_13_damas, start_date, end_date, has_super_tiebreak, match_duration, registration_fee } = body;
